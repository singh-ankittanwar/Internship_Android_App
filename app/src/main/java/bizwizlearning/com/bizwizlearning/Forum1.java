...
public class Forum1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference().child("Forums").child("General").push().setValue(new ChatMessage(input.getText().toString(),
    ...
    private void displayChatMessage() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this, ChatMessage.class, R.layout.message_item, FirebaseDatabase.getInstance().getReference().child("Forums").child("General"))
        {
            @Override
